...
|--------------------------------------------------------------------------
|
| The namespace related to the application folder
|
*/
...
|--------------------------------------------------------------------------
|
| An array of callables that are passed to the spl_autoload_register() function
|
*/
$config['classes_autoload'] = array(
    function ($class) {
        $application_namespace_length = strlen(config_item('application_namespace'));
        if (substr($class, 0, $application_namespace_length) == config_item('application_namespace')) {
            require APPPATH . str_replace('\\', DIRECTORY_SEPARATOR, substr($class, $application_namespace_length + 1)) . '.php';
        }
    },
);
